...
This repository contains generic puppet module for installing and configuring WSO2 BRS on various environments. It
supports multiple versions of WSO2 BRS. Configuration data is managed using [Hiera] (http://docs.puppetlabs.com/hiera/1/). 
...
Do the below changes to relevant BRS profiles (worker, manager) hiera yaml files to start the server in distributed
setup. For more details refer [WSO2 BRS 2.2.0](https://docs.wso2
.com/display/CLUSTER44x/Clustering+Business+Rules+Server) and [WSO2 BRS 2.1.0](https://docs.wso2
.com/display/CLUSTER420/Clustering+Business+Rules+Server) clustering guide.
...
2. Add secure vault configurations as below
    ...
    For BRS 2.2.0 which is based on carbon kernel 4.4.x
