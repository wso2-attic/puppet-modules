...
Do the below changes to relevant ES profiles (store, publisher) hiera yaml files to start the server in distributed setup. For more details refer the [WSO2 ES clustering guide](https://docs.wso2.com/display/CLUSTER44x/Clustering+ES+2.0.0)
