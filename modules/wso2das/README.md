...
This repository contains generic puppet module for installing and configuring WSO2 DAS on various environments. It
supports multiple versions of WSO2 DAS. Configuration data is managed using [Hiera] (http://docs.puppetlabs.com/hiera/1/). 
...
refer the [WSO2 DAS clustering guide](https://docs.wso2.com/display/CLUSTER44x/Clustering+Data+Analytics+Server)
...
WSO2 DAS needs to have sensitive data such as passwords, keys in configuration files and put them as plain text in
