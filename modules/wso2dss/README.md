...
This repository contains generic puppet module for installing and configuring WSO2 DSS on various environments. It
supports multiple versions of WSO2 DSS. Configuration data is managed using [Hiera] (http://docs.puppetlabs.com/hiera/1/). 
...
Do the below changes to relevant DSS profiles (manager, worker) hiera yaml files to start the server in distributed 
setup.
